...
__bpf_kfunc int
bpf_parse_header_msg_func(void *src, int src__sz)
{
	return parse_protocol_impl(src);
}

__bpf_kfunc int
bpf_setsockopt_func(void *bpf_socket, int bpf_socket__sz, int optname, const char *opt, int opt__sz)
{
