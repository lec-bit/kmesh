...
LDFLAGS := "-X google.golang.org/protobuf/reflect/protoregistry.conflictPolicy=warn \
			-X lec-bit/kmesh/pkg/version.gitVersion=$(VERSION) \
			-X lec-bit/kmesh/pkg/version.gitCommit=$(GIT_COMMIT_HASH) \
			-X lec-bit/kmesh/pkg/version.gitTreeState=$(GIT_TREESTATE) \
			-X lec-bit/kmesh/pkg/version.buildDate=$(BUILD_DATE) \
