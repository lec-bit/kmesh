...
extern int bpf_setsockopt_func(void *ctx, int ctx__sz, int optname, const char *opt, int opt__sz) __ksym;
extern int bpf_getsockopt_func(void *ctx, int ctx__sz, int optname, char *opt, int opt__sz) __ksym;
...
int bpf_km_setsockopt(void *ctx, int level, int optname, const char *optval, int optval__sz) {
...
int bpf_km_getsockopt(void *ctx, int level, int optname, const char *optval, int optval__sz) {
    if (level != IPPROTO_TCP) {
        return -1;
    }
    struct bpf_mem_ptr msg_tmp = {
