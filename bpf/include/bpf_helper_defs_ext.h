...
static int (*bpf_km_strnstr)(struct bpf_sock_addr *ctx, const char *key, int key_sz, const char *subptr, int subptr_sz) = (void *)163;
static int (*bpf_km_strncmp)(struct bpf_sock_addr *ctx, const char *key, int key_sz, const char *subptr, int subptr_sz) = (void *)164;
static long (*bpf_parse_header_msg)(struct bpf_mem_ptr *msg) = (void *)165;
